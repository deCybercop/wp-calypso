...
class ImportPreview extends Component {
		...
		this.previewData = {
			wordpress: {
				supported: [
					translate( 'Posts' ),
					translate( 'Pages' ),
					translate( 'Images and other media' ),
					translate( 'Comments' ),
				],
	...
	renderPreview() {
		...
		let trimmedSiteUrl = importSiteUrl.replace( /^https?:\/\//i, '' );
	...
	render() {
		...
		// The preceding steps always provide a value for the engine
		const headerText = translate( 'We found your existing content.' );
		const subHeaderText = translate(
			"We'll take this content and add it to your new WordPress site."
		);
